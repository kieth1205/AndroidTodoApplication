...
import com.thang.noteapp.common.NoScrollListView;
import com.thang.noteapp.common.eventbus.AddTodoEvent;
import com.thang.noteapp.controller.TodosAdapter;
...
public class HomeActivity extends AppCompatActivity {
    ...
    public void openTodoEvent(View view) {
        startActivity(new Intent(this, AddTodoEvent.class));
    }
    ...
    public void loadListView(NoScrollListView listView, final ArrayList<HashMap<String, String>> dataList) {
        TodosAdapter adapter = new TodosAdapter(this, dataList, mydb);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                Intent i = new Intent(MainActivity.this, AddTodoEvent.class);
